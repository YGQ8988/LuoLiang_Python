    ...
    <td valign="top" background="{% static 'qx/images/67_16.jpg' %}"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td background="{% static 'qx/images/67_07.jpg' %}" height="60"><table width="100%" height="44" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td style="padding-left:60px; font-weight:bold;">联系我们</td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td background="{% static 'qx/images/67_10.jpg' %}" height="379" valign="top" class="black12a"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="7%" height="382">&nbsp;</td>
            <td width="88%"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="50%" class="black14a" style="line-height:40px;"><span style="font-weight: bold">上海芊详建筑工程有限公司 </span><br />
		   ...
		   邮箱：398972844@qq.com
                ...
                <td><img src="{% static 'qx/images/kf1.jpg' %}" width="233" height="324" /></td>
              </tr>
            </table></td>
            <td width="5%">&nbsp;</td>
          </tr>
